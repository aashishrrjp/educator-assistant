...
import {
  ...
  User,
  LogOut,
  MessageSquare, // Renamed from Languages
  ClipboardCheck, // Added for Quiz
  Users, // Added for Attendance
  Heart,
} from "lucide-react"
...
export function TeacherNav() {
  ...
  const navItems = [
    ...
    { href: "/teacher/quiz", label: "Quiz Builder", icon: ClipboardCheck },
  ...
  // The component now returns the <aside> element directly.
  return (
